...
//    }; //이미지파일 저장 끝
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.e(TAG, "NewMainActivity에서 onCreate 시작!");
...
//        }); //촬영버튼 이벤트 끝
    ...
    public void carInfoDialog(final String carNumber) {
        ...
        AlertDialog.Builder dialog = new AlertDialog.Builder(NewMainActivity.this);
...
//        dialog.setView(et);
        ...
        dialog.setPositiveButton("차량등록", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                // "차량등록" 클릭시 등록화면으로 이동
                Intent registerIntent = new Intent(NewMainActivity.this, Car_Insert.class);
                // 다이얼로그에서 인식결과 insert 화면으로 보내기
                registerIntent.putExtra("차번호", carNumber);

                NewMainActivity.this.startActivity(registerIntent);
...
//    }
    ...
    private void captureCamera(){
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            Intent takePictureIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE); //카메라 불러옴
            Log.d("촬영", "완료2" );
...
//                        new MakeNetworkCall().execute("http://3.16.54.45:80/http.php?post=1", "Post");
                    ...
                    Toast.makeText(NewMainActivity.this, "번호판 촬영을 취소했습니다", Toast.LENGTH_SHORT).show();
                }
                break;
        ...
        switch (requestCode) {
            case MY_PERMISSION_CAMERA:
                for (int i = 0; i < grantResults.length; i++) {
                    ...
                    if (grantResults[i] < 0) {
                        Toast.makeText(NewMainActivity.this, "해당 권한을 활성화 하셔야 합니다.", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
                break;
    ...
    public void uploadFile(String filePath){
        ...
        try {
            UploadFile uploadFile = new UploadFile(NewMainActivity.this);
