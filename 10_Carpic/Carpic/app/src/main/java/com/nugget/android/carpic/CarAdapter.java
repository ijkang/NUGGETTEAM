...
public class CarAdapter extends ArrayAdapter<CarInfo> {
    ...
    public CarAdapter(Context mCtx, int listLayoutRes, List<CarInfo> carList, SQLiteDatabase mDatabase) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final CarInfo car = carList.get(position);
    ...
    private void updateCar(final CarInfo car) {
